...
use sp_runtime::{
	...
	traits::{AccountIdLookup, BlakeTwo256, Block as BlockT, IdentifyAccount, Verify, NumberFor, One},
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("supersig-template"),
	impl_name: create_runtime_str!("supersig-template"),
	authoring_version: 1,
...
impl pallet_balances::Config for Runtime {
	...
	type RuntimeEvent = RuntimeEvent;
	type DustRemoval = ();
	type ExistentialDeposit = ConstU128<50>;
